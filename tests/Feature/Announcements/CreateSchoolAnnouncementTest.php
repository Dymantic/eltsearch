...
class CreateSchoolAnnouncementTest extends TestCase
{
    use RefreshDatabase;
     ...
     *@test
     */
    public function create_an_announcement_for_schools()
    {
        $this->withoutExceptionHandling();

        $response = $this->asAdmin()->postJson('/api/admin/school-announcements', [
    ...
    private function assertFieldIsInvalid($field)
    {
        ...
        $response = $this
            ->asAdmin()
            ->postJson('/api/admin/school-announcements', array_merge($valid, $field));
