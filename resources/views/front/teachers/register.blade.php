<x-public-page title="Signup for ELTSearch">
    ...
    <p class="type-b3 my-4 text-center">Already a member? <a href="" class="type-b4 text-sky-blue hover:text-navy ">Sign in</a>

    <form action="/register/teacher" method="post" class="max-w-md mx-auto">
        {!! csrf_field() !!}
        <div class="my-6">
        ...
        <div class="text-center my-12">
            <button class="btn-main type-a1" type="submit">Sign Up</button>
        </div>
