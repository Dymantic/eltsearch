...
class SchoolProfileReinstated extends Notification implements ActionableNotification, ShouldQueue
{
    use Queueable;

    protected string $trans_key = 'notifications.school_reinstated.';
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->markdown('email.schools.profile-reinstated', ['body' => $this->getMessageFor($notifiable)]);
    }
